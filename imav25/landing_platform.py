...
class LandingPlatformNode(Node):
    def __init__(self):
        super().__init__('landing_platform')
        self.get_logger().info('landing_platform node started')
